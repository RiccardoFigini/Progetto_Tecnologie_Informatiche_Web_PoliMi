...
public class GoToAuctionDetails extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			/** Se l'utente in sessione non è il proprietario dell'asta. Non posso entrare
			 * nel dettaglio di un asta se non sono il proprietario */
			if (auctionBean.getUserIdOwner() != userId) {
				throw new ErrorException("Error! Permission denied.");
			}

			/** Metto le immagini agli articoli */
